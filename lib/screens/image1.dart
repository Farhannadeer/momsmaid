            ...
            child: Column(
              ...
              children: [
                ...
                Container(
                  ...
                  child: Text("Ginger Garlic Paste 250 Gms", style: TextStyle(fontFamily: "Montserrat",fontWeight: FontWeight.w500, color: Colors.black, fontSize: MediaQuery.of(context).size.height / 32),),
                ),
                Container(
                  child: Stack(
                    children: [
                      ...
                      Container(
                        ...
                        child: PageView(
                          ...
                          children: [
                            Container(
                              child: Image.asset('images/injiPaste250gmsSmallFront.jpeg'),
                            ...
                            Container(
                              child: Image.asset('images/injiPaste250gmsSmallBack.jpeg'),
                      ...
                      Container(
                        ...
                        child: Image.asset('images/price45.png'),
                      ),
                ...
                Container(
                  ...
                  child: Row(
                    ...
                    children: [
                      ...
                      SizedBox(width: 5,),
                      Container(
                        child: Text("(250 Gms)",style: TextStyle(fontFamily: "Montserrat", fontWeight: FontWeight.bold,color: Colors.black,fontSize: MediaQuery.of(context).size.height / 54),),
                      )
                    ],
                  ),
                ),
                Container(
                  ...
                  child: Row(
                    children: [
                      ...
                      Text("\u{20B9}14",style: TextStyle(fontFamily: "Montserrat", fontWeight: FontWeight.bold,color: buttonRed,fontSize: MediaQuery.of(context).size.height / 54),)
                    ],
                  ),
                ),
                Provider.of<Data>(context).item1?Container(
