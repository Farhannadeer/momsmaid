            ...
            child: Column(
              ...
              children: [
                ...
                Container(
                  ...
                  child: Text("Ginger Garlic Paste 1 Kg", style: TextStyle(fontFamily: "Montserrat",fontWeight: FontWeight.w500, color: Colors.black, fontSize: MediaQuery.of(context).size.height / 32),),
                ),
                Container(
                  child: Stack(
                    children: [
                      ...
                      Container(
                        ...
                        child: PageView(
                          ...
                          children: [
                            Container(
                              child: Image.asset('images/injiPaste1KgSmallFront.jpeg'),
                            ...
                            Container(
                              child: Image.asset('images/injiPaste1KgSmallBack.jpeg'),
                      ...
                      Container(
                        ...
                        child: Image.asset('images/price150.png'),
                      ),
                ...
                Container(
                  ...
                  child: Row(
                    ...
                    children: [
                      ...
                      SizedBox(width: 5,),
                      Container(
                        child: Text("( 1 Kg )",style: TextStyle(fontFamily: "Montserrat", fontWeight: FontWeight.bold,color: Colors.black,fontSize: MediaQuery.of(context).size.height / 54),),
                      )
                    ],
                  ),
                ),
                Container(
                  ...
                  child: Row(
                    children: [
                      ...
                      Text("\u{20B9}85",style: TextStyle(fontFamily: "Montserrat", fontWeight: FontWeight.bold,color: buttonRed,fontSize: MediaQuery.of(context).size.height / 54),)
                    ],
                  ),
                ),
                Provider.of<Data>(context).item3?Container(
